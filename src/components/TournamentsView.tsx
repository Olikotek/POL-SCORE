    ...
    <section className="tournaments-view-wrapper">
      <style>{`
        ...
        @media (max-width: 640px) {
          ...
          /* Tabela główna turniejów na telefonie */
          .col-mob-date {
          ...
          /* Tabela listy startowej na telefonie */
          .col-start-nr {
      ...
      {selectedTournament ? (
        ...
        <div className="tournaments-table-container">
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '2px solid #0f172a', paddingBottom: '10px', marginBottom: '12px', flexWrap: 'wrap', gap: '8px' }}>
            <div>
          ...
          <div className="tournaments-table-box">
            <table className="tourn-table-main">
              <thead>
                <tr>
                  <th className="col-start-nr" style={{ width: '28px', textAlign: 'center', padding: '6px 2px' }}>Nr</th>
                  <th className="col-start-player" style={{ padding: '6px 4px' }}>Zawodnik</th>
                  <th className="col-start-flag" style={{ width: '28px', textAlign: 'center', padding: '6px 2px' }}>Kraj</th>
                  <th className="col-start-cat" style={{ width: '48px', textAlign: 'center', padding: '6px 2px' }}>Kat.</th>
                  <th className="mobile-hide" style={{ width: '120px', padding: '6px 6px' }}>Klub</th>
                  <th className="mobile-hide" style={{ width: '90px', padding: '6px 6px' }}>Miasto</th>
                  <th className="col-start-status" style={{ width: '74px', textAlign: 'center', padding: '6px 2px' }}>Opłata</th>
                </tr>
              </thead>
              <tbody>
                {filteredRegisteredPlayers.map((p, index) => {
                  return (
                    <tr key={p.id} style={{ borderBottom: '1px solid #f1f5f9', background: index % 2 === 0 ? '#ffffff' : '#f8fafc' }}>
                      <td className="col-start-nr" style={{ textAlign: 'center', fontWeight: 800, color: '#64748b', padding: '6px 2px' }}>
                        {index + 1}
                      </td>
                      <td className="col-start-player" style={{ padding: '6px 4px', overflow: 'hidden' }}>
                        <div style={{ display: 'flex', flexDirection: 'column', minWidth: 0 }}>
                          <button
                            type="button"
                            onClick={() => onOpenPlayer(p.id)}
                            style={{ background: 'none', border: 'none', padding: 0, color: '#0284c7', fontWeight: 800, fontSize: '11px', cursor: 'pointer', textAlign: 'left', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}
                          >
                            {p.name}
                            {p.isAmateur && (
                      ...
                      <td className="col-start-flag" style={{ textAlign: 'center', padding: '6px 2px' }}>
                        <img
                          src={p.flagImage || flagEmoji(p.flag || 'PL')}
                          alt={p.flag || 'PL'}
                          style={{ width: '16px', height: '11px', objectFit: 'cover', borderRadius: '2px', border: '1px solid #cbd5e1', display: 'inline-block' }}
                        />
                      </td>
                      <td className="col-start-cat" style={{ fontWeight: 700, color: '#334155', textAlign: 'center', padding: '6px 2px' }}>
                        {p.category}
                      </td>
                      <td className="mobile-hide" style={{ padding: '6px 6px', color: '#64748b', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                        {p.club || '–'}
                      </td>
                      <td className="mobile-hide" style={{ padding: '6px 6px', color: '#64748b', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                        {p.city || '–'}
                      </td>
                      <td className="col-start-status" style={{ textAlign: 'center', padding: '6px 2px' }}>
                        <span
                          style={{
                            display: 'inline-flex',
                            alignItems: 'center',
          ...
          <div className="tournaments-table-container">
            ...
            <div className="tournaments-table-box">
              <table className="tourn-table-main">
                <thead>
                  <tr>
                    <th className="col-mob-date" style={{ width: '68px', padding: '6px 4px' }}>Data</th>
                    <th className="col-mob-tourn" style={{ padding: '6px 4px' }}>Turniej</th>
                    <th className="mobile-hide" style={{ width: '130px', padding: '6px 6px' }}>Pole</th>
                    <th className="mobile-hide" style={{ width: '85px', padding: '6px 4px', textAlign: 'center' }}>Status</th>
                    <th className="col-mob-registered" style={{ width: '32px', padding: '6px 1px', textAlign: 'center' }}>Zap.</th>
                    <th className="col-mob-action" style={{ width: '86px', padding: '6px 1px', textAlign: 'center' }}>Akcja</th>
                  </tr>
                </thead>
                <tbody>
                  {filteredTournaments.map((t, idx) => {
                    ...
                    return (
                      <tr key={t.id} style={{ borderBottom: '1px solid #f1f5f9', background: idx % 2 === 0 ? '#ffffff' : '#f8fafc' }}>
                        <td className="col-mob-date" style={{ padding: '6px 4px', color: '#64748b', fontWeight: 700 }}>
                          {t.date}
                        </td>
                        <td className="col-mob-tourn" style={{ padding: '6px 4px', overflow: 'hidden' }}>
                          <div style={{ display: 'flex', flexDirection: 'column', minWidth: 0 }}>
                            <button
                              type="button"
                        ...
                        <td className="mobile-hide" style={{ padding: '6px 6px', color: '#475569', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                          {t.courseName || 'Pole Turniejowe PFFG'}
                        </td>
                        <td className="mobile-hide" style={{ padding: '6px 4px', textAlign: 'center' }}>
                          {isCompleted ? (
                        ...
                        <td className="col-mob-registered" style={{ textAlign: 'center', fontWeight: 900, color: '#0f172a', padding: '6px 1px' }}>
                          {displayCount}
                        </td>
                        <td className="col-mob-action" style={{ textAlign: 'center', padding: '6px 1px' }}>
                          <div style={{ display: 'flex', gap: '2px', alignItems: 'center', justifyContent: 'center' }}>
                            <button
                              ...
                              onClick={() => setSelectedTournament(t)}
                              title="Zobacz listę"
                              style={{ background: '#f1f5f9', border: '1px solid #cbd5e1', borderRadius: '3px', padding: '3px 5px', fontSize: '9.5px', fontWeight: 800, cursor: 'pointer', color: '#475569', display: 'flex', alignItems: 'center', gap: '2px' }}
                            >
                              <Eye size={10} /> Lista
                            </button>
                            {!isCompleted && (
                              <button
                                ...
                                title="Zapisz się"
                                style={{ background: '#0284c7', border: 'none', color: '#fff', borderRadius: '3px', padding: '3px 5px', fontSize: '9.5px', fontWeight: 800, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '2px' }}
                              >
                                <UserPlus size={10} /> Zapisz
                              </button>
                            )}
                          </div>
                        </td>
